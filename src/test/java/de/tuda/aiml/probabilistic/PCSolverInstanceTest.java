...
public class PCSolverInstanceTest {
    ...
    public void Bodyguard_putting_antidote() throws Exception {
        ...
        ProbabilisticCausalitySolverResult result = pcSolver.solve(Assassin, context, phi, cause, ProbabilisticSolvingStrategy.PC);
    ...
    public void Engineer_flipping_switch_cause_of_train_arrival() throws Exception {
        ...
        ProbabilisticCausalitySolverResult causalitySolverResultExpectedEval =
                new ProbabilisticCausalitySolverResult(true, true, true, cause,
                        new HashSet<>(Arrays.asList(f.literal("RB", false))));

        ProbabilisticCausalitySolverResult result = pcSolver.solve(Switching, context, phi, cause, ProbabilisticSolvingStrategy.PC);
    ...
    public void Alice_shooting_cause_of_deers_death() throws Exception {
        ...
        ProbabilisticCausalitySolverResult result = pcSolver.solve(Deer, context, phi, cause, ProbabilisticSolvingStrategy.PC);
    ...
    public void Boulder_fall_not_cause_of_hiker_surviving() throws Exception {
        ...
        ProbabilisticCausalitySolverResult result = pcSolver.solve(Boulder, context, phi, cause, ProbabilisticSolvingStrategy.PC);
