...
import static de.tuda.aiml.probabilistic.SATSolverType.*;

class SATProbabilisticCausalitySolver extends ProbabilisticCausalitySolver {
     ...
     */
    @Override
    public ProbabilisticCausalitySolverResult solve(ProbabilisticCausalModel causalModel, Set<Literal> context, Formula phi, Set<Literal> cause,
                                ProbabilisticSolvingStrategy solvingStrategy) throws InvalidCausalModelException {
     ...
     * @throws InvalidCausalModelException thrown if internally generated causal models are invalid
     */
    ProbabilisticCausalitySolverResult solve(ProbabilisticCausalModel causalModel, Set<Literal> context, Formula phi,
                                             Set<Literal> cause, ProbabilisticSolvingStrategy solvingStrategy, SATSolverType satSolverType)
    ...
    private Set<Literal> fulfillsAC2(ProbabilisticCausalModel causalModel, Formula phi, Set<Literal> cause, Set<Literal> context,
                                     Set<Literal> evaluation, ProbabilisticSolvingStrategy solvingStrategy,
     ...
     */
    private boolean fulfillsAC3Helper(ProbabilisticCausalModel causalModel, Formula phi, Set<Literal> cause,
     ...
     * @throws InvalidCausalModelException thrown if internally generated causal models are invalid
     */
    private Pair<Set<Literal>, Boolean> fulfillsAC2AC3(ProbabilisticCausalModel causalModel, Formula phi, Set<Literal> cause,
                                                       Set<Literal> context, Set<Literal> evaluation,
                                                       boolean phiOccurred, ProbabilisticSolvingStrategy solvingStrategy,
                                                       SATSolverType satSolverType, FormulaFactory f)
            throws InvalidCausalModelException {
        Set<Literal> w;
        boolean ac3;
        ...
        if (cause.size() == 1 || !phiOccurred) {
            ...
            ProbabilisticSolvingStrategy solvingStrategyNew;
            if (solvingStrategy == ProbabilisticSolvingStrategy.SAT_COMBINED) {
                solvingStrategyNew = ProbabilisticSolvingStrategy.SAT;
            } else {
                solvingStrategyNew = ProbabilisticSolvingStrategy.SAT_MINIMAL;
            }
     ...
     */
    private Set<Literal> getWStandard(ProbabilisticCausalModel causalModelModified, Set<Literal> evaluation, Assignment assignment) {
        // generate (maximum) W
     ...
     * @return a set W if AC2 is fulfilled; null otherwise
     */
    private Set<Literal> getWMinimal(ProbabilisticCausalModel causalModelModified, Set<Literal> evaluation,
     ...
     * @return a formula
     */
    private Formula generateSATQuery(ProbabilisticCausalModel causalModel, Formula notPhi, Set<Literal> cause,
                                     Set<Literal> context, Set<Literal> evaluation, ProbabilisticSolvingStrategy solvingStrategy,
