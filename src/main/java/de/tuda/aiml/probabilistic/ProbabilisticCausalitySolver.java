...
public abstract class ProbabilisticCausalitySolver {
     ...
     */
    protected abstract ProbabilisticCausalitySolverResult solve(ProbabilisticCausalModel causalModel, Set<Literal> context, Formula phi,
    ...
    Set<ProbabilisticCausalitySolverResult> getAllCauses(ProbabilisticCausalModel causalModel, Set<Literal> context, Formula phi,
                                                         ProbabilisticSolvingStrategy solvingStrategy, FormulaFactory f)
            throws InvalidCausalModelException {
     ...
     * @throws InvalidCausalModelException thrown if internally generated causal models are invalid
     */
    ProbabilisticCausalModel createModifiedCausalModelForW(ProbabilisticCausalModel causalModel, Set<Literal> w, FormulaFactory f)
            throws InvalidCausalModelException {
     ...
     */
    static Set<Variable> getMinimalWVariables(ProbabilisticCausalModel causalModel, Formula phi, Set<Literal> cause,
                                              FormulaFactory f) {
    ...
    /**
     * Helper method for {@link ProbabilisticCausalitySolver#createModifiedCausalModelForCause(ProbabilisticCausalModel, Set, FormulaFactory)}
     * and {@link ProbabilisticCausalitySolver#createModifiedCausalModelForW(ProbabilisticCausalModel, Set, FormulaFactory)}.
     *
     * @param causalModel the causal model
